...
-- Insert test Midtrans logs (DIPERBAIKI - menggunakan CONCAT untuk JSON)
...
VALUES 
('RENT-20240101-ABC123', 'MIDTRANS-TEST-001', 'settlement', 'accept', 'credit_card', 'bca', NULL, 1400000, CONCAT('{"status": "success", "settlement_time": "', DATE_FORMAT(NOW() - INTERVAL 2 DAY, '%Y-%m-%d %H:%i:%s'), '"}')),
